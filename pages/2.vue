...
<template>
	<div class="pb-10 flex justify-evenly">
		<div class="block">
			<div
				class="md:flex mx-auto mt-5 md:mx-32 justify-around md:mt-20 lg:mt-60 2xl:mt-72"
			>
				<!-- Generic Profile Information -->
				<div class="md:mx-0 w-fit">
					<img
						src="/Aervy_Icon.png"
						class="w-40 rounded-full h-auto"
					/>
						...
						>
							...
							<li class="text-aervyon max-w-prose">
								<p class="text-secondary-text-dark max-w-prose">
									perpetually
									<span class="text-aervyon">learning</span>
									new things by
